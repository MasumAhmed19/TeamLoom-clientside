...
const Home = () => {
    return (
        <div className=''>
            ...
            <section className="min-h-screen bg-black text-whit p-2">
                <div className="container mx-auto">
                    <h2 className="f2 text-[5vh] md:text-[5vh] leading-[60px] lg:leading-[80px] text-center text-gray-200 md:w-2/3 mx-auto leading-tight">Everything You Need to Manage Your Team Efficiently</h2>
                </div>
