...
const Sidebar = ({ onClose }) => {
    ...
    const admin = [
        ...
        { name: 'Employee List', path: '/dashboard/employee-list', icon:<RiDashboardFill /> },
    ...
    const hr = [
        { name: 'Profile', path: '/dashboard/profile', icon:<RiDashboardFill /> },
        { name: 'Employee List', path: '/dashboard/employee-list', icon:<RiDashboardFill /> },
        { name: 'Payment History', path: '/dashboard/payment-history', icon:<RiDashboardFill /> },
        { name: 'Progress', path: '/dashboard/progress ', icon:<RiDashboardFill /> },
        { name: 'Notifications', path: '/dashboard/notifications', icon:<RiDashboardFill /> },
    ];
